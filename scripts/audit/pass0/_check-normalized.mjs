...
console.log("string-entry wheels (should be 0):", (await q(`select count(*)::int n from vehicle_fitments where quarantined_at is null and jsonb_typeof(oem_wheel_sizes)='array' and jsonb_typeof(oem_wheel_sizes->0)='string'`)).n);
