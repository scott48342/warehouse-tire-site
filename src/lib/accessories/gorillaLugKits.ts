...
export function titleNeedleForThread(key: LugThreadKey): string[] {
  switch (key) {
    case "m12x1.50":
      return ["12X1.5", "12-1.5", "12 X 1.5", "M12X1.5", "M12-1.5", "M12 1.5", "12MM"];
    case "m12x1.25":
      return ["12X1.25", "12-1.25", "12 X 1.25", "M12X1.25", "M12-1.25", "M12 1.25"];
    case "m14x1.50":
      return ["14X1.5", "14-1.5", "14 X 1.5", "M14X1.5", "M14-1.5", "M14 1.5", "14MM"];
    case "m14x1.25":
      return ["14X1.25", "14-1.25", "14 X 1.25", "M14X1.25", "M14-1.25", "M14 1.25"];
    case "1/2-20":
      return ["1/2-20", "1/2 20", "1/2X20", "1/2 X 20", ".50-20"];
    case "7/16-20":
      return ["7/16-20", "7/16 20", "7/16X20", "7/16 X 20"];
  }
}
