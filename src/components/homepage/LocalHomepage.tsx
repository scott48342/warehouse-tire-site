...
// ═══════════════════════════════════════════════════════════════════════════════
// 
// Design reference: local homepage.png
// Clean, professional, green accent color scheme
// Split hero with storefront photo, horizontal search widget
// ═══════════════════════════════════════════════════════════════════════════════
...
function HeroSection() {
  ...
  return (
    <section className="relative bg-neutral-800">
          ...
          <div className="px-6 py-12 lg:px-12 lg:py-16">
            ...
            <div className="mt-8 flex flex-wrap gap-6">
              <div className="flex items-center gap-2 text-white/90 text-sm">
                ...
                <span>Same-Day<br className="sm:hidden" /> Installation</span>
              </div>
              <div className="flex items-center gap-2 text-white/90 text-sm">
                <CheckCircle className="w-5 h-5 text-green-500" />
                <span>Expert<br className="sm:hidden" /> Installation</span>
              </div>
              <div className="flex items-center gap-2 text-white/90 text-sm">
                <DollarSign className="w-5 h-5 text-green-500" />
                <span>Honest<br className="sm:hidden" /> Pricing</span>
              </div>
            </div>
          </div>
      ...
      <div className="relative z-20 mx-auto max-w-6xl px-4 -mb-16 lg:-mb-20">
        <div className="bg-white rounded-xl shadow-xl p-6">
          <div className="flex flex-col lg:flex-row lg:items-end gap-6">
            ...
            {/* Store Card */}
            <div className="lg:w-64 lg:border-l lg:pl-6 border-neutral-200">
  ...
  const props = [
    {
      ...
      description: "We live and work in this community. Thank you for supporting local!",
    },
    {
      icon: Truck,
      title: "SAME-DAY INSTALLATION",
      description: "Most tires installed the same day.",
    },
    {
      icon: DollarSign,
    ...
    },
    {
      ...
      description: "Our trained technicians install your tires right.",
    },
  ];
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="mt-2 text-3xl md:text-4xl font-bold text-neutral-900">
            Real People. Real Service. Right Around the Corner.
          </h2>
        </div>
          ...
          {props.map((prop) => {
            ...
            return (
              <div key={prop.title} className="text-center">
                ...
                <h3 className="font-bold text-neutral-900 text-sm uppercase tracking-wide">{prop.title}</h3>
...
function BrandLogos() {
  return (
    <section className="bg-white py-12 border-t border-neutral-200">
      <div className="mx-auto max-w-6xl px-4">
        <p className="text-center text-sm font-bold tracking-wide text-green-700 uppercase mb-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
          {TIRE_BRANDS.map((brand) => (
            ...
            >
              {/* Text fallback - will be replaced by images when available */}
...
// ═══════════════════════════════════════════════════════════════════════════════
// LOCAL STORY / SOCIAL PROOF SECTION
// ═══════════════════════════════════════════════════════════════════════════════
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-4 text-neutral-700">
              We keep it simple: great tires, honest prices, and friendly service you can count on.
            </p>
            <ul className="mt-6 space-y-3">
              {[
                ...
                `Local and proud to serve Oakland County`,
              ].map((item) => (
          ...
          {/* CENTER - Photo */}
          <div className="relative rounded-xl overflow-hidden h-64 lg:h-auto bg-neutral-200">
            <Image
            ...
            <div className="absolute bottom-4 left-4 right-4 text-center">
              <div className="inline-block bg-white/90 backdrop-blur-sm rounded-lg px-4 py-2">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-neutral-500">
              — Jason R., {PRIMARY_STORE.city.split(",")[0]}
            </p>
            ...
            {/* Mini Store Card */}
            <div className="mt-6 bg-white rounded-lg p-4 shadow-sm border border-neutral-200">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-1 inline-block text-sm font-semibold text-green-700 hover:underline"
                  >
                    Get Directions
                  </a>
                </div>
  ...
  const items = [
    {
      ...
      description: "We'll match eligible competitor prices.",
    },
    {
      icon: Shield,
      title: "QUALITY TIRES",
      description: "We only sell tires we trust for your safety.",
    },
    {
      icon: Calendar,
      title: "FLEXIBLE SCHEDULING",
      description: "Walk-ins welcome or book online.",
    },
    {
      icon: Heart,
      title: "HERE FOR YOU",
      description: "Friendly experts ready to help.",
    },
  ];
      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-bold text-neutral-900">MON – FRI 8AM – 5PM</p>
              <p className="text-neutral-900">SAT 8AM – 3PM</p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-bold text-neutral-900">{PRIMARY_STORE.address}</p>
              <p className="text-neutral-900">{PRIMARY_STORE.city}</p>
              <a
                href={PRIMARY_STORE.mapsUrl}
                target="_blank"
                rel="noopener noreferrer"
        ...
        {STORES.length > 1 && (
          <div className="mt-8 pt-6 border-t border-neutral-200">
            <p className="text-sm text-neutral-500 mb-4">Also visit our {STORES[1].name} location:</p>
