    ...
    <div className="bg-[#1a1a1a] border-b border-white/10">
      <div className="max-w-[1400px] mx-auto px-4">
        <div className="flex items-center justify-between py-3 gap-6 overflow-x-auto">
          {/* Google Reviews — lead with social proof */}
          <div className="flex items-center gap-3 text-sm whitespace-nowrap">
            <div className="flex items-center text-base leading-none text-amber-400">★★★★★</div>
            <div>
              <p className="text-white font-semibold">{TRUST.reviewsDisplay} Google Reviews</p>
              <p className="text-white/40 text-xs">{TRUST.ratingDisplay}★ · {TRUST.decadesDisplay}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 text-sm whitespace-nowrap">
            ...
            <div>
              ...
              <p className="text-white/40 text-xs">Fast, reliable delivery nationwide</p>
            </div>
          </div>
...
const TRUST_BADGES = [
  ...
  { icon: "shipping", title: "Fast Shipping Nationwide", subtitle: "Quick, reliable delivery to your door." },
...
// NOTE: The old placeholder ReviewsSection (fake reviews + inaccurate
// "24,000+" count) was replaced by <ReviewCarousel /> which renders the real
// Google reviews and the accurate count from src/data/store-reviews.json.
