/**
 * Dynamic OG Image for Packages SEO Pages
 */
...
export const alt = "Wheel & Tire Packages - Warehouse Tire Direct";
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "2px solid #404040", paddingTop: "30px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "40px" }}>
            <div style={{ color: "#a3a3a3", fontSize: 24 }}>✓ Mounted &amp; Balanced</div>
            <div style={{ color: "#a3a3a3", fontSize: 24 }}>✓ TPMS Included</div>
          </div>
