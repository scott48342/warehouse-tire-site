  ...
  return (
    <main className="bg-neutral-50">
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <form className="mt-6 flex flex-wrap items-end gap-2" action="/tires/c/all-season" method="get">
          ...
          <Link href="/tires/c/all-season" className="h-10 rounded-xl border border-neutral-200 bg-white px-4 py-2 text-sm font-extrabold">
            Clear
          </Link>
        </form>
