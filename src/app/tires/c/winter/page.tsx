...
export default async function WinterTiresPage({
  searchParams,
}: {
      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <h1 className="text-2xl font-extrabold text-neutral-900">Winter tires</h1>
            <div className="mt-1 text-sm text-neutral-700">Browse winter tires across brands. Select a product to view details and build a quote.</div>
          </div>
        ...
        <form className="mt-6 flex flex-wrap items-end gap-2" action="/tires/c/winter" method="get">
          ...
          <Link href="/tires/c/winter" className="h-10 rounded-xl border border-neutral-200 bg-white px-4 py-2 text-sm font-extrabold">
            Clear
          </Link>
        </form>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {items.length ? (
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-4 text-sm text-neutral-700 sm:col-span-2 lg:col-span-3">
              No winter tires found. Try clearing brand/rim filters.
            </div>
          )}
        </div>
      </div>
