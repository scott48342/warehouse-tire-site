      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_420px]">
          ...
          <div className="lg:sticky lg:top-6 rounded-3xl border border-neutral-200 bg-white p-6">
            {/* Fitment Summary - Compact for above-fold */}
            {year && make && model ? (
              <div className="mb-3 flex items-center justify-between gap-3 rounded-xl bg-green-50 border border-green-200 px-3 py-2">
                <div className="flex items-center gap-2">
            ...
            {/* ═══════════════════════════════════════════════════════════════════
                ABOVE THE FOLD: Title → Finish → Price → CTA
            ...
            <div id="quote" className="mt-4 rounded-2xl border-2 border-green-500 bg-gradient-to-br from-green-50 to-emerald-50 p-4 shadow-lg shadow-green-100/50">
              {/* Price */}
            ...
            <div className="mt-6 grid gap-3">
              ...
              <div className="rounded-2xl border border-neutral-200 bg-white p-4">
                <div className="text-xs font-extrabold text-neutral-900 mb-3">Specifications</div>
              ...
              {/* Detailed Fitment Guide - below fold */}
              {year && make && model && (
            ...
            <div className="mt-4 flex items-center justify-between text-xs text-neutral-500">
              <span>SKU: {sku}</span>
              <a href={BRAND.links.tel} className="font-semibold text-neutral-700 hover:underline">
                Questions? Call us
              </a>
            </div>
          </div>
